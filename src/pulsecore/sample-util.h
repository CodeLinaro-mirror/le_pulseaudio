...
#define PA_CHANNEL_POSITION_MASK_LEFT                                   \
    (PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_FRONT_LEFT)           \
     ...
     | PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_REAR_LEFT_OF_CENTER) \
     ...
     | PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_FRONT_LEFT_WIDE)    \
     | PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_TOP_SIDE_LEFT))
...
#define PA_CHANNEL_POSITION_MASK_RIGHT                                  \
    (PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_FRONT_RIGHT)          \
     ...
     | PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_REAR_RIGHT_OF_CENTER) \
     ...
     | PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_FRONT_RIGHT_WIDE)   \
     | PA_CHANNEL_POSITION_MASK(PA_CHANNEL_POSITION_TOP_SIDE_RIGHT))
