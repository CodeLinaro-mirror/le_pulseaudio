...
typedef enum {
    ...
    PA_QAHW_JACK_TYPE_LAST = PA_QAHW_JACK_TYPE_HDMI,
...
typedef pa_hook_result_t (* pa_qahw_jack_callback_t) (void *dummy __attribute__((unused)), pa_qahw_jack_event_data_t *event_data, void *prv_data);
