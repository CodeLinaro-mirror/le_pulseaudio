...
typedef enum {
    ...
    PA_PAL_JACK_TYPE_NATIVE_HDMI_OUT = 0x8000,
    PA_PAL_JACK_TYPE_BTLE_OUT = 0x10000,
    PA_PAL_JACK_TYPE_BTLE_IN = 0x20000,
    PA_PAL_JACK_TYPE_BTLE_VOIP_OUT = 0x40000,
    PA_PAL_JACK_TYPE_BTLE_VOIP_IN = 0x80000,
    PA_PAL_JACK_TYPE_LAST = PA_PAL_JACK_TYPE_BTLE_VOIP_IN,
